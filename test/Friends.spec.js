  ...
  describe('Route /friends/chron/haters/:idtoken', function() {
    ...
    describe('Utility: findNewHatersAndFriends', function() {
      ...
      it('should return an object with haters properly populated', function() {
        ...
        expect(noneNewHater).to.have.property('friends')
          .that.is.an('array')
          .to.have.lengthOf(0)
      })

      it('should return an object with friends properly populated', function() {
        ...
        expect(noneNewFriends).to.have.property('friends')
          .that.is.an('array')
          .to.have.lengthOf(0)
      })
    })
